...
public class CardUtil {
	...
	public static String veriftBankCard(String bankNum) {
        ...
        if (bankNum != null && bankNum.length() > 0) {
            if (bankNum.length() != 16 && bankNum.length() != 18 && bankNum.length() != 19) {
                resultText =  "银行卡号错误";
            } else if (bankNum.length() == (15) || bankNum.length() == (16)) {
                if (bankNum.startsWith("6225") || bankNum.startsWith("4514") || bankNum.startsWith("4392") || bankNum.startsWith("4367") || bankNum.startsWith("5187") ||
                        bankNum.startsWith("5236") || bankNum.startsWith("5218") || bankNum.startsWith("5194") || bankNum.startsWith("5123") || bankNum.startsWith("3568")) {
                    resultText =  "十分抱歉！暂时不支持出金到信用卡";
                }
            } else {
                resultText = "YES";
            }
